...
class Config:
    ...
    DEFAULT_LANGUAGE = os.getenv("ROLEX_LANG", "auto")
    MATH_LOCAL_ONLY = True
    ...
    REMOTE_LAB_TOKEN = os.getenv("ROLEX_LAB_TOKEN", "")

    @classmethod
    def ensure_dirs(cls) -> None:
        for d in (cls.DATA_DIR, cls.LOG_DIR, cls.MEMORY_DIR, cls.KB_DIR,
